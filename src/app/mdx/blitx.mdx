...
This project explores that question through the design and implementation of Blitx, a full-stack proof-of-concept dashboard for managing autonomous vehicles (robotaxis).

The autonomous vehicle domain was chosen because it naturally involves rich backend logic — such as ride requests, scheduling, vehicle state transitions, and routing — which makes it a strong fit for demonstrating the advantages of hexagonal architecture.
