...
const PageContent = dynamic(
  () => import('@/app/mdx/digital-patient-twin.mdx'),
  { ssr: false },
)
...
export default function ProjectPage() {
  ...
  // You can load different MDX files based on projectId if needed
  // const projectId = params.projectId
  // const Content = projectId === 'my-project' ? MyProjectContent : OtherProjectContent
