...
const Data: ProjectData[] = [
  ...
  },
  {
    ...
    title: 'My Portfolio',
    description:
      'This is my portfolio website where I showcase my projects and skills. This website is made with Next.js, Tailwind CSS, and TypeScript. I also used Framer Motion for animations and Google Fonts for the fonts. I also used the Next.js Image component to optimize the images.',
  ...
  },
  {
    ...
    description:
      "this was one of my first projects, it was a webste for a psychologist. I made this website with the use of a CSM called ProccesWire that's powered on PHP along with SCSS, VueJS, and CSS frameworks such as UIkit and Bootstrap.",
    image: 'projects/qxhim9q0e86wwgajnsjw',
    tags: ['PHP', 'SCSS', 'VueJS', 'UIkit', 'Bootstrap'],
  ...
  },
  {
    ...
    tags: ['Nuxt', 'TypeScript', 'Azure', 'CosmosDB', 'Dapr'],
  },
